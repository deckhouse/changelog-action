...
exports.PullRequestChange = exports.Change = exports.parseSingleChange = exports.parsePullRequestChanges = exports.collectChanges = void 0;
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const body = yield (0, changes_1.collectChanges)(inputs);
